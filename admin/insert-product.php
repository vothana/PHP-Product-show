								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea name="productDescription" placeholder="Enter Product Description" rows="12" class="span8 tip">
</textarea>
											</div>
										</div>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color: green; color: whitesmoke;">Insert</button>
											</div>
										</div>
									</form>
								</div>
